  ...
  <ComicCard>
    ...
    <form onsubmit={handleSubmit}>
      <div class="fields">
        ...
        <ComicInput
          bind:value={techStackStr}
          label="Tech Stack"
          placeholder="TypeScript, Svelte, PocketBase (comma-separated)"
        />
      </div>
      <div class="actions">
        <ComicButton variant="primary" type="submit" loading={isCreating}
          >Create Project</ComicButton
        >
